...
<body class="mq-store">
    ...
    <div class="mq-float" aria-label="{{ __('store.nav.quick_contact') }}">
        <a class="mq-float-call" href="tel:+1001234567890" aria-label="{{ __('store.nav.call') }}">
        ...
        <a class="mq-float-wa" href="https://wa.me/1001234567890" target="_blank" rel="noopener" aria-label="{{ __('store.nav.whatsapp') }}">
